 ...
 * @author Pikachu
 */
public class Jabar extends javax.swing.JFrame {

    /**
     * Creates new form Jabar
     */
    public Jabar() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Jabar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
